...
public class SSCycleScrollView: UIScrollView {
...
extension SSCycleScrollView: UIScrollViewDelegate {
...
//MARK: - private method
fileprivate extension SSCycleScrollView {
  func configScrollView(_ frame: CGRect) {
